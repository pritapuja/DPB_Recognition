...
# pixel_crop = 10  # Lurus => 11
# pixel_crop = 15  # miring_bawah, atas


# test_folder = 'temp test/tests_1/tasbih_asli'
# test_folder = 'temp test/lurus'
# test_folder = 'tests/tasbih_asli'
test_folder = 'tests/tasbih_asli'
